        ...
        <div className="bg-joinus my-32">
            <div className='mx-auto max-w-2xl lg:max-w-7xl sm:py-4 lg:px-8'>
                ...
                <div className="text-center">
                    <h3 className="text-blue text-lg font-normal tracking-widest">Travel with Ease.</h3>
                    <h2 className="text-4xl sm:text-6xl font-bold my-6 leading-10"> Our travel experience manager <br /> is ready to support you.</h2>
                ...
                <div className="mx-auto max-w-4xl pt-5">
                    <div className="sm:flex items-center mx-5 p-5 sm:p-0 rounded-xl justify-between bg-lightgrey sm:rounded-full">
                        ...
                        <div>
                            <input type="number" className="my-4 py-4 sm:pl-6 lg:text-xl text-black sm:border-l border-linegrey bg-lightgrey focus:outline-none bg-emailbg focus:text-black" placeholder="Your Phone" autoComplete="off" />
                        </div>
